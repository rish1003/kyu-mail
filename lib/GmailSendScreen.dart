...
import 'package:kyu_mail/reusables/cutom_textfield.dart';
import 'package:kyu_mail/reusables/text.dart';
import 'package:kyu_mail/reusables/textfield.dart';
import 'package:mailer/mailer.dart';
import 'package:open_file/open_file.dart';


class GmailSendScreen extends StatefulWidget {
  GmailSendScreen({Key? key});

  @override
  State<GmailSendScreen> createState() => _GmailSendScreenState();
}

class _GmailSendScreenState extends State<GmailSendScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              print(emails.toString()+ccemails.toString()+bccemails.toString());
              MainController.instance.send_email(emails,ccemails,bccemails,subject.text.toString(),message.text.toString(),attachments);
            },
            color: Colors.white,
          ),
        ],
