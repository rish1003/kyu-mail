...
class replymail extends StatefulWidget {
  ...
  @override
  State<replymail> createState() => _openmailState();
}

class _openmailState extends State<replymail> {
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: TextField(
                              style: TextStyle(
                                  color: Color(0xFFD8D8D8), fontSize: 18.0),
                              // Set the text color
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Color(
                                    0xFF595959), // Background color of the button
                              ),
                              child: Text(
                                selectedFileName,
                                style: TextStyle(
