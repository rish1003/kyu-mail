...
class forwardingmail extends StatefulWidget {
  forwardingmail({super.key});

  @override
  State<forwardingmail> createState() => _forwardingmailState();
}

class _forwardingmailState extends State<forwardingmail> {
                      ...
                      children: [
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Enter your message', // Set the hint text
                            hintStyle: TextStyle(
